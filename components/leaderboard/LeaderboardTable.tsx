          ...
          {rowVirtualizer.getVirtualItems().map((virtualRow) => {
            ...
            return (
              ...
              >
                ...
                <div role="cell" className="px-6 w-36 text-sm font-semibold text-emerald-400">
                  +{user.profit.toLocaleString()}
                </div>
                <div role="cell" className="px-6 w-32 text-sm text-slate-300">
                  {user.winRate}%
                </div>
                <div role="cell" className="px-6 w-32 text-sm text-slate-400">
                  {user.predictions}
                </div>
              </div>
            );
