      ...
      <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="mb-6 space-y-2">
            <h1 className="text-h1-responsive text-white">Predict.</h1>
            <h1 className="text-h1-responsive text-white">Repeat.</h1>
            <div className="inline-block bg-gradient-to-r from-[#7C3AED] to-[#5B21B6] px-4 py-2 rounded-lg">
              <h1 className="text-h1-responsive text-white">Earn.</h1>
            </div>
          </div>

          {/* Description */}
          <p className="mb-8 max-w-lg text-body-lg leading-relaxed text-white/90">
