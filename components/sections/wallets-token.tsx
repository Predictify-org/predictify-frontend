...
const WalletConnectIcon = () => (
  <Image
    src="/assets/wallets/walletconect.svg"
    alt="Walletconect Logo"
    width={93}
    height={93}
  />
);
...
const TrustWalletIcon = () => (
  <Image
    src="/assets/wallets/trust-wallet.svg"
...
const PredictifyTokenIcon = () => (
  <Image
    src="/assets/tokens/predictify.svg"
    alt="Predictify Logo"
    width={93}
    height={93}
  />
...
const TOKENS = [
  ...
  {
    ticker: "Predictify Token",
    icon: PredictifyTokenIcon,
    alt: "Predictify Platform Token Logo",
  },
];
      ...
      <div className="bg-slate-900/70 p-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="mb-12">
          ...
          <p className="mt-4 text-xl text-gray-400 max-w-3xl mx-auto">
            Predictify works seamlessly with the most popular wallets and tokens
