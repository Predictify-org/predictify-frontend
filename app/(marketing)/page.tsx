 ...
 * Navbar → Hero → KpiStrip → Features → HowItWorks → WalletsTokens → CTA → Footer
 *
 * Renders a full-screen gradient background with decorative blur orbs
 * and an animated background layer behind all sections.
 */
