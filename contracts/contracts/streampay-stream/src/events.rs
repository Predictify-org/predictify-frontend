...
//! | amended   | "amended"   | (stream_id: u64, sender: Address, old_end_time: u64, new_end_time: u64, old_total_amount: i128, new_total_amount: i128, timestamp: u64) |
//!
...
/// Emits the `stream::amended` event after `amend_stream` has updated
/// the stream's end time and/or total amount.
pub fn amended(
    env: &Env,
    stream_id: u64,
    sender: &Address,
