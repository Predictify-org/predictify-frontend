...
export interface WalletModalProps {
  ...
  /**
   * When true, entrance / exit animations on the modal are disabled.
   * Defaults to respecting the system prefers-reduced-motion preference.
   */
...
export function WalletModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent reducedMotion={reducedMotion} className="sm:max-w-md rounded-lg">
        <DialogHeader>
          ...
          {walletOptions.map((wallet) => {
            ...
            return (
              <Button
                ...
                className={`flex items-center justify-start cursor-pointer gap-3 w-full p-4 h-auto hover:bg-muted ${
